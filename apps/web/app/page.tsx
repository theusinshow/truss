...
export default function Home() {
  ...
  return (
    <main className="h-dvh overflow-hidden text-truss-text">
      <section className="flex h-dvh flex-col overflow-hidden border-x border-truss-line bg-truss-base/88 shadow-truss-panel lg:mx-4 xl:mx-6">
